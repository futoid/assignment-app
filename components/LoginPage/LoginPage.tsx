    ...
    return (
        <div>
            <div className=" grid grid-cols-2 gap-2 h-screen">
                <div className=" bg-gradient-to-r from-[#4285F4] to-[#286DE0] -skew-x-12 -translate-x-20">
                    ...
                    <div>
                        ...
                        <div className=" flex flex-row gap-6">
                            ...
                            <div className=" flex flex-row gap-4 p-2 mt-8 ml-4 bg-white rounded-xl">
                                ...
                                <p className="flex text-[#858585] font-montserrat justify-center items-center"> Sign in with Apple</p>
                            </div>
                        </div>

                        <div className=' flex flex-col gap-1 px-8 py-10 rounded-xl mt-8 ml-4 bg-white font-lato'>
                            <Input
